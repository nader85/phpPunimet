...
INSERT INTO `users` (`id`, `emri`, `mbiemri` `username`, `email`, `password`, `is_admin`) VALUES
(1, 'Arlinda', 'Arlinda', 'arlinda', 'arlindaosmani00@gmail.com', '$2y$10$0VBVvKNyxIl9OA00/FRmrep7atIIE/SoLXGEoXcjNmF.4ZV6b3NIG', 'true'),
(2, 'iljas', 'iljas', 'iljas', 'iljas@iljas.com', '$2y$10$erk7uFn0RpqhC6g3VX.XcuyU3CVkOanelghahzqjmdtxeFwfEgQQO', ''),
(3, 'linda', 'linda', 'linda', 'linda@linda.com', '$2y$10$pzATPYrl/LDDmFp8DIxalOrvUNT2RL4.I3pFbRjGrsUE8L/xH9O32', 'true');
